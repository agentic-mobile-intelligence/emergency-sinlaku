...
test.describe("T-LP: Landing Page", () => {
  ...
  test("T-LP-03: emergency banner is visible", async ({ page }) => {
    const banner = page.locator("text=EMERGENCY")
