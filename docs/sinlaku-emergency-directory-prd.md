...
/volunteer          → Volunteer sign-up page (no login required)
/volunteer/sheets   → Browse all open sign-up sheets
...
│                                                             │
│  ┌───────────────────────────────────────────────────┐      │
│  │  🙋 Volunteer — Sign up to help with relief       │      │
│  │  efforts. No experience required.  [See Sheets →] │      │
│  └───────────────────────────────────────────────────┘      │
│                                                             │
│  Emergency Contacts:                                        │
